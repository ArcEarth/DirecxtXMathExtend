...
#undef vec4i_swizzle2
	...
	inline XMVECTOR XM_CALLCONV	XMVectorMaxInt(FXMVECTOR V1, FXMVECTOR V2)
	{
#if defined(_XM_NO_INTRINSICS_)

		XMVECTOR Result;
		Result.vector4_u32[0] = (V1.vector4_u32[0] > V2.vector4_u32[0]) ? V1.vector4_u32[0] : V2.vector4_u32[0];
		Result.vector4_u32[1] = (V1.vector4_u32[1] > V2.vector4_u32[1]) ? V1.vector4_u32[1] : V2.vector4_u32[1];
		Result.vector4_u32[2] = (V1.vector4_u32[2] > V2.vector4_u32[2]) ? V1.vector4_u32[2] : V2.vector4_u32[2];
		Result.vector4_u32[3] = (V1.vector4_u32[3] > V2.vector4_u32[3]) ? V1.vector4_u32[3] : V2.vector4_u32[3];
		return Result;
	...
	inline XMVECTOR XM_CALLCONV	XMVectorMinInt(FXMVECTOR V1, FXMVECTOR V2)
	{
#if defined(_XM_NO_INTRINSICS_)
		XMVECTOR Result;
		Result.vector4_u32[0] = (V1.vector4_u32[0] < V2.vector4_u32[0]) ? V1.vector4_u32[0] : V2.vector4_u32[0];
